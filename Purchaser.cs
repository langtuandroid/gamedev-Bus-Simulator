...
public class Purchaser : MonoBehaviour, IStoreListener
{
	...
	public static string unlockAll = "unlock_all";
	private void  Awake(){
		Instance=this;
	}
	private void Start ()
	...
	public PurchaseProcessingResult ProcessPurchase (PurchaseEventArgs args)
	{
		...
		if (String.Equals (args.purchasedProduct.definition.id, removeads, StringComparison.Ordinal)) {
			PlayerPrefs.SetInt ("IsAdRemoved",6676);
			Debug.Log ("Thanks for removing Ads");
		}
		else if (String.Equals (args.purchasedProduct.definition.id, unlockAll, StringComparison.Ordinal)) {
			PlayerPrefs.SetInt ("UnlockAllBuses",6676);
			Debug.Log ("Thanks for unlockAllStuff");
		}
