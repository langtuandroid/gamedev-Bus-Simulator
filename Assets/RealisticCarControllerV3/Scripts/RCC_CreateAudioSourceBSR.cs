...
public class RCC_CreateAudioSourceBSR : MonoBehaviour {

	public static AudioSource NewAudioSourceBSR(GameObject go, string audioName, float minDistance, float maxDistance, float volume, AudioClip audioClip, bool loop, bool playNow, bool destroyAfterFinished){
	...
	public static void NewHighPassFilterBSR(AudioSource source, float freq, int level){
